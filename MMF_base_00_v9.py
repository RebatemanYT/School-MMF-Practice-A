...
while name != "xxx" and ticket_count < MAX_TICKETS:
  ...
  #Ask user if they want the instructions and if they want it, prints out.
  instructions(yes_no)
  ...
  #Print empty line to have space between orders
  print()
...
#Pre-Printing/Export
#Format currency to have $(.2dp)
add_dollar = ['Ticket', 'Sna$', 'Sur', 'Total', 'SubT']
for item in add_dollar:
  movie_frame[item] = movie_frame[item].apply(currency)

#Write each frame to a seperate csv file
